...
var data = [
  {
    date: `01月6號,2024 ,`,
    title: "期許",
    content: `<p>嘿，我是宏勳 好久好久不見了，我想聊一下近期的想法。</p>

<p>首先，在2023年三月我到了一家接案公司，</p>

<p>在公司內使用的技能比起以前的.NET Framework可以說是新了常非常多，使用的是.NET 6跟.NET 7</p>

<p>我對能在技術上的成長感到很開心，感到充實。</p>
...
<ol>
	<li>我對.NET Core瞭解得更深</li>
	<li>我對後台架構有更多瞭解</li>
	<li>我在開發上能夠更快的寫出前端需求的API</li>
	<li>在EFCore 我能使用更複雜的Lambda寫出Query</li>
	<li>使用Swagger自動生成文件</li>
</ol>

<p>我想看看自己是否有能力在別的地方也能適應，但Google了幾間公司在面試上卻都是考<em><strong>演算法</strong></em></p>

<p>這幾天嘗試想練習LeetCode卻有種無能為力的感覺，我想到過去在大學修演算法時沒有認真讀</p>

<p>沒辦法寫出Run Time更低的Code，覺得非常懊悔。</p>

<p>&nbsp;</p>

<p>今年2024我對自己得期望有2個</p>
