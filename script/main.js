...
var data=[
       ...
       ,
    {
        ...
        `在國興裡面待了3個月, 目前的心得想在這上面記錄一下, 這三個月期間我認為我是學到很多, 包括.net 6 以及 MVC 架構, 從自己原本只想做前端到目前接觸到C#、webAPI、MVC網頁以及jQuery，在短短的時先內真的接觸到很多，但也了解到其實公司框架這種東西雖然真的方便快速好維護，但是真的會限制你的想法、作法。
       ...
       ,
    {
        ...
        `可能先前太常使用 var、const 在 C# 中卻必須要明確規範變數、參數的型別、再加上vs community 的熱鍵其實非常難用...，寫起來確實挺折磨人的，不過第一個禮拜學到了如何製作web api以及幾個簡單的winform 、使用C# 的http傳輸 post、get等方法，不得不說，好久沒有這種學到新東西的感覺了...意外的開心`
    }
       ,
    {
        date:'12月10號,2021 ,',
        ...
        `12/6號 我轉職成為winform全端工程師的職位，主要工作初步認識應該是pos機跟DB的作業，據了解客戶好像是喫茶，糖村跟多那支。今天剛好是入職的第一個禮拜五。期待接下來的各種挑戰。`
       }
       ,
   {
     date:'10月12號,2021 ,',
